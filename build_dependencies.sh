...
apt update
apt install -y valgrind lcov clang libsystemd-dev meson libcunit1 libcunit1-dev curl libunwind-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
pip install jsonref
