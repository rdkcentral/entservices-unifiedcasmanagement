...
############################
# Build entservices-unifiedcasmanagement
echo "======================================================================================"
echo "buliding entservices-unifiedcasmanagement"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-unifiedcasmanagement \
-DUSE_THUNDER_R4=ON \
...
-DDS_FOUND=ON \
-DPLUGIN_UNIFIEDCASMANAGEMENT=ON \
